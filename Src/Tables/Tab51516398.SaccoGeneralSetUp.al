...
Table 51516398 "Sacco General Set-Up"
{
    ...
    fields
    {
        ...
        field(55;"Sender Address";Text[70])
        {
        }
        ...
        field(183;"Package Retrieval Charge Acc";Code[15])
        {
            TableRelation = "G/L Account"."No.";
        }
        ...
        field(200;"EFT Fee Account";Code[20])
        {
            DataClassification = ToBeClassified;
        }
        ...
        field(209;"Minimum Loan Eligibilty New";Code[10])
        {
            DataClassification = ToBeClassified;
        }
        field(210;"Min Loan Eligibility Rejoining";Code[10])
        {
            DataClassification = ToBeClassified;
        }
        field(211;"BOSA Reg Fee Class B";Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(212;"Minimun Shares Group";Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(213;"penalty on all arrears";Code[5])
        {
            DataClassification = ToBeClassified;
        }
        field(214;"Fosa Interest(%)";Decimal)
        {
            DataClassification = ToBeClassified;
        }
    }
