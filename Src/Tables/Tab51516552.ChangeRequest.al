...
Table 51516552 "Change Request"
{
    ...
    fields
    {
                ...
                if  ((Type=Type::"Mobile Change") or (Type=Type::"ATM Change") or (Type=Type::"Agile Change")) then begin
                       ...
                       vend.SetRange(vend."No.","Account No");
                        ...
                        begin
                         ...
                         "Picture(New Value)":=vend.Picture;
                        "signinature(New Value)":=vend.Signature;


                        end;
                //          vend.RESET;
                //          venDATd.SETRANGE(vend."BOSA Account No",Memb."No.");
                //         IF vend.FIND('-') THEN
                //        "Member Class":=Memb."Member class";
                //        "Member Class (New)":=Memb."Member class";
                ...
                if Type=Type::"Backoffice Change" then begin
                  ...
                  if Memb.Find('-') then begin
                       ...
                       "Status.":=Memb.Status;
                        ...
                        "Picture(New Value)":=Memb.Picture;
                        "signinature(New Value)":=Memb.Signature;
                        Dateofbirth:=Memb."Date of Birth";
                        Gender:=Memb.Gender;
                    end;
        ...
        {
            OptionCaption = 'Married,Single,I';
            OptionMembers = Married,Single,I;
        }
        ...
        field(28;"Signing Instructions";Option)
        {
        ...
        {
            OptionCaption = ' ,Single,Married,Devorced,Widower,Widow,I';
            OptionMembers = " ",Single,Married,Devorced,Widower,Widow,I;
        }
        ...
        field(78;"Signing Instructions(NewValue)";Option)
        {
            OptionCaption = 'Any to Sign,Two to Sign,Three to Sign,All to Sign';
            OptionMembers = "Any to Sign","Two to Sign","Three to Sign","All to Sign";
        }
        ...
        field(95;"Member Class";Option)
        {
            DataClassification = ToBeClassified;
            OptionCaption = ',Class A,Class B';
            OptionMembers = ,"Class A","Class B";
        }
        field(96;"Member Class (New)";Option)
        {
            DataClassification = ToBeClassified;
            OptionCaption = ',Class A,Class B';
            OptionMembers = ,"Class A","Class B";
        }
        field(97;Dateofbirth;Date)
        {
            DataClassification = ToBeClassified;
        }
        field(98;Dateofbirthnew;Date)
        {
            DataClassification = ToBeClassified;
        }
        field(99;Gender;Option)
        {
            DataClassification = ToBeClassified;
            OptionCaption = ' ,Male,Female,I';
            OptionMembers = " ",Male,Female,I;
        }
        field(100;"Gender NEW";Option)
        {
            DataClassification = ToBeClassified;
            OptionCaption = ' ,Male,Female,I';
            OptionMembers = " ",Male,Female,I;
