...
Table 51516381 "Loan Products Setup"
{
    ...
    fields
    {
        ...
        field(130;"Auto Offset Period";DateFormula)
        {
            DataClassification = ToBeClassified;
        }
        field(131;"Allow Self Guarantee";Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(132;"Interest rate 2";Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(133;"Allow class B";Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(134;"Use Free Deposits";Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(135;"Check Residence";Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(136;"Appraise Income";Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(137;"Percentage of Rent Income";Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(138;"Suspend Interest Account [G/L]";Code[20])
        {
            DataClassification = ToBeClassified;
        }
        field(139;"Auctioneer%";Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(140;"Auction acc";Code[20])
        {
            DataClassification = ToBeClassified;
        }
        field(141;"CRB Loan Product Type";Code[30])
        {
            DataClassification = ToBeClassified;
        }
    }
