...
Table 51516509 "Membership Reg. Products Appli"
{
    ...
    fields
    {
        ...
        field(6;"Last No. Issued";Code[20])
        {
            CalcFormula = lookup("Account Types-Saving Products"."Last No Used" where (Code=field(Product)));
            FieldClass = FlowField;
        }
        field(7;"Default Account";Boolean)
        {
        }
    }
    ...
    keys
    {
        key(Key1;"Membership Applicaton No",Names,Product)
        {
            Clustered = true;
        }
    }
