...
Table 51516360 "Membership Applications"
{
    ...
    fields
    {
        ...
        field(68005;"E-Mail (Personal)";Text[20])
        {
        ...
        field(68018;"Monthly Contribution";Decimal)
        {
            ...
            begin
                GenSetUp.Get();
                if "Monthly Contribution"<GenSetUp."Min. Contribution"
                  then begin
        ...
        field(68048;"Bank Account No";Code[50])
        {
        }
        ...
        {
            TableRelation = if ("How Did you know About Us"=filter(Staff)) "HR Employees"."No."
                            else if ("How Did you know About Us"=filter("Another Member")) "Member Register"."No.";
        ...
        {
            OptionCaption = 'New Application,Account Reactivation';
            OptionMembers = "New Application","Account Reactivation";
        }
        ...
        field(68122;"Contracting Details";Text[10])
        {
        }
        ...
        field(68125;"Joint Account Name";Text[100])
        {
        ...
        field(68130;"Member Parish Name 2";Text[10])
        {
        ...
        {
            OptionCaption = 'None,Any to Sign,Two to Sign,Three to Sign,All to Sign';
            OptionMembers = "None","Any to Sign","Two to Sign","Three to Sign","All to Sign";
        }
        ...
        {
            OptionCaption = ' ,Single,Joint,Group';
            OptionMembers = " ",Single,Joint,Group;
        }
        ...
        field(69118;"Name 3";Code[50])
        {
        }
        field(69120;"Secondary Mobile No";Code[20])
        {
        }
        field(69121;"How Did you know About Us";Option)
        {
            ...
            begin
                if "Member Class"="member class"::"Class A" then begin
                  if "Account Category"="account category"::Corporate then
                    Error('Institutional accounts can only have class B Membership');

                  if "Account Category"="account category"::Group then
                    Error('Group accounts can only have class B Membership');
                end;
            end;
        }
        ...
        field(69172;Region;Text[50])
        {
            DataClassification = ToBeClassified;
            TableRelation = Regions;
        }
        field(69173;Signing;Text[50])
        {
            DataClassification = ToBeClassified;
        }
    }
    ...
    fieldgroups
    {
        fieldgroup(DropDown;"No.",Name,"Phone No.",Field91,"Global Dimension 2 Code","Global Dimension 1 Code")
        {
        }
    }
    ...
    begin
        ...
        //AutoLoad Default Accounts
        SavProductsApp.Reset;
        MembershipApp.Init;
        SavProductsApp.SetRange(SavProductsApp."Default Account",true);
        if SavProductsApp.Find('-') then begin
           if MembershipApp.Product<>'' then
           MembershipApp.Insert;
          end;
    end;
    ...
    var
        ...
        SavProductsApp: Record "Account Types-Saving Products";
        MembershipApp: Record "Membership Reg. Products Appli";
        UserMgt: Codeunit "User Management";
    ...
    begin
        ...
        ObjSelectedSavingsProducts.SetRange(ObjSelectedSavingsProducts."Default Account",true);
        ...
        if ObjSavingsProduct.FindSet(true) then begin
          repeat
            if ObjSavingsProduct."Default Account"=true then begin
              ...
              ObjSelectedSavingsProducts."Default Account":=true;
