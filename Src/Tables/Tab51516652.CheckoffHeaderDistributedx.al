...
Table 51516652 "Checkoff Header-Distributedx"
{
    ...
    fields
    {
        ...
        {
            CalcFormula = count("Checkoff Lines-Distributed" where ("Staff Not Found"=field(No)));
        ...
        {
            CalcFormula = sum("Checkoff Lines-Distributed"."Employer Code" where ("Staff Not Found"=field(No)));
            FieldClass = FlowField;
        }
    }
