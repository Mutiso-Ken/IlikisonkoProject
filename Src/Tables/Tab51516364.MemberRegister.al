...
Table 51516364 "Member Register"
{
    ...
    fields
    {
        ...
        {
            TableRelation = Vendor."No." where("BOSA Account No" = field("No."),
                                                "Vendor Posting Group" = const('ORDINARY ACCOUNT'));
        }
        ...
        {
            CalcFormula = - sum("Member Ledger Entry".Amount where("Customer No." = field("No."),
                                                                   "Transaction Type" = const("Loan Insurance Paid"),
                                                                   "Posting Date" = field("Date Filter"),
                                                                   "Document No." = field("Document No. Filter")));
            Editable = false;
            FieldClass = FlowField;
        ...
        {
            CalcFormula = - sum("Member Ledger Entry".Amount where("Customer No." = field("No."),
                                                                   "Transaction Type" = filter("Loan Insurance Paid" | "Recovery Account"),
                                                                   "Posting Date" = field("Date Filter")));
            Editable = false;
            FieldClass = FlowField;
        }
        ...
        field(68183; "Member withdrawable Deposits"; Decimal)
        {
            CalcFormula = sum("Member Ledger Entry".Amount where("Customer No." = field("No."),
                                                                  "Posting Date" = field("Date Filter"),
                                                                  "Document No." = field("Document No. Filter"),
                                                                  "Transaction Type" = const("FOSA Account")));
            FieldClass = FlowField;
        }
        ...
        {
            CalcFormula = lookup("Member Account Signatories"."Account No" where("BOSA No." = field("No.")));
            FieldClass = FlowField;
        }
        field(68186; "Xmas Contribution"; Decimal)
        {
            CalcFormula = - sum("Member Ledger Entry".Amount where("Customer No." = field("No."),
                                                                   "Transaction Type" = const("Auctioneer charged"),
                                                                   "Posting Date" = field("Date Filter"),
                                                                   "Document No." = field("Document No. Filter")));
            Editable = false;
            FieldClass = FlowField;
        ...
        field(69086; "Contracting Details"; Text[5])
        {
        }
        ...
        field(69092; "Passport 2"; Code[5])
        {
        }
        field(69093; "Member Parish 2"; Code[5])
        {
            Enabled = false;
        }
        field(69094; "Member Parish Name 2"; Text[5])
        {
            Enabled = false;
        }
        field(69095; "Name of the Group/Corporate"; Text[5])
        {
        }
        ...
        field(69143; "Pension No"; Code[10])
        {
        }
        ...
        field(69146; "BRID No"; Code[5])
        {
        }
        field(69147; "Gross Dividend Amount Payable"; Decimal)
        {
        }
        field(69148; "Card No"; Code[5])
        {
        }
        ...
        field(69153; "Member House Group"; Code[5])
        {
        ...
        field(69154; "Member House Group Name"; Code[5])
        {
        }
        ...
        field(69160; "FOSA Account"; Code[10])
        {
        }
        ...
        field(69210; "Additional Shares"; Decimal)
        {
            CalcFormula = - sum("Member Ledger Entry".Amount where("Customer No." = field("No."),
                                                                   "Posting Date" = field("Date Filter"),
                                                                   "Document No." = field("Document No. Filter"),
                                                                   "Transaction Type" = const("Interest Due")));
            FieldClass = FlowField;
        }
        ...
        field(69234; "Ordinary Savings"; Decimal)
        {
            CalcFormula = - sum("Member Ledger Entry".Amount where("Customer No." = field("No."),
                                                                   "Transaction Type" = filter("Ordinary Savings"),
                                                                   "Posting Date" = field("Date Filter")));
            FieldClass = FlowField;
        }
        ...
        field(69238; Staff; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(69239; Board; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        ...
        field(69242; "Property Count"; Integer)
        {
            CalcFormula = count(Property where("Owner No" = field("No.")));
            FieldClass = FlowField;
        }
        field(69243; Region; Code[25])
        {
            DataClassification = ToBeClassified;
            TableRelation = Regions;
        }
        field(69244; "Unique Id"; Integer)
        {
            DataClassification = ToBeClassified;
        }
        field(69245; Lstus; Code[10])
        {
            DataClassification = ToBeClassified;
        }
        field(69246; "Outstanding Penalty"; Decimal)
        {
            CalcFormula = sum("Member Ledger Entry".Amount where("Customer No." = field("No."),
                                                                  "Transaction Type" = filter("Penalty Charged" | "Penalty Paid")));
            FieldClass = FlowField;
        }
        field(69247; update; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(69248; "Auctioneer Charges"; Decimal)
        {
            CalcFormula = sum("Member Ledger Entry".Amount where("Customer No." = field("No."),
                                                                  "Transaction Type" = filter("Auctioneer Paid" | "Auctioneer charged")));
            FieldClass = FlowField;
        }
    }
    ...
    fieldgroups
    {
        fieldgroup(DropDown; "No.", Name, "Member class", "ID No.", "Mobile Phone No")
        {
        }
    }
