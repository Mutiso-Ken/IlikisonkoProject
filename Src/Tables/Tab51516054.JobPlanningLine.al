...
Table 51516054 "Job-Planning Line"
{
    ...
    DrillDownPageID = UnknownPage53955;
    LookupPageID = UnknownPage53955;
    PasteIsValid = false;
    ...
    fields
    {
        ...
        field(7;"No.";Code[20])
        {
            ...
            TableRelation = if (Type=const(Resource)) Resource else if (Type=const(Item)) Item else if (Type=const("G/L Account")) "G/L Account" where ("Donor defined Account"=filter(Yes)) else if (Type=const(Text)) "Standard Text";
        ...
        field(1032;"Invoice No.";Code[20])
        {
            ...
            trigger OnLookup()
            var
                JobCreateInvoice: Codeunit "HR Leave Jnl.-Postt";
            begin
    ...
    var
        ...
        Job: Record UnknownRecord51516213;
