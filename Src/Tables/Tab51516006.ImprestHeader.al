    ...
    fields
    {
        ...
        field(28;"Paying Bank Account";Code[20])
        {
            ...
            begin
                ...
                if "Paying Account Type"="paying account type"::"Bank Account" then
                  begin
                    if BankAcc.Get("Paying Bank Account") then
                      begin
                      "Bank Name":=BankAcc.Name;
                    ...
                    if "Paying Account Type"="paying account type"::"FOSA Account" then
                      begin
                      if Vend.Get("Paying Bank Account") then
                        begin
                        "Bank Name":=Vend.Name;
                        end;
                      end;
