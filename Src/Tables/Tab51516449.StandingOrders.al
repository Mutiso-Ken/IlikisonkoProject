...
Table 51516449 "Standing Orders"
{
    ...
    fields
    {
        ...
        field(5;"Destination Account Type";Option)
        {
            ...
            OptionMembers = Internal,BOSA,Loans;
            ...
            begin
                ...
                //"Destination Account Type":="Destination Account Type"::BOSA
        ...
        field(6;"Destination Account No.";Code[50])
        {
            TableRelation = if ("Destination Account Type"=const(Internal)) Vendor."No." where ("Creditor Type"=const("Savings Account"))
                            else if ("Destination Account Type"=const(BOSA)) "Member Register"."No.";
            ...
            begin
                ...
                if MemberList.Get("Destination Account No.") then begin

                "Destination Account Name":=MemberList.Name;
        ...
        field(50007;"Destination Loan No";Code[30])
        {
    ...
    var
        ...
        MemberList: Record "Member Register";
}
