...
Table 51516271 "Jobss"
{
    ...
    DrillDownPageID = UnknownPage53926;
    LookupPageID = UnknownPage53926;
    ...
    var
        ...
        JobResPrice: Record UnknownRecord53931;
        JobItemPrice: Record UnknownRecord53932;
        JobGLAccPrice: Record UnknownRecord53933;
    begin
    ...
    var
        ...
        JobSetup: Record UnknownRecord53925;
        ...
        JobTask: Record UnknownRecord53926;
        JobTasks: Record UnknownRecord53926;
        JobPlanningLine: Record UnknownRecord53928;
        JobPlanningLines: Record UnknownRecord53928;
        ProjectPartners: Record UnknownRecord53942;
        ProjectDonors: Record UnknownRecord53943;
        ProjectPartner: Record UnknownRecord53942;
        ProjectDonor: Record UnknownRecord53943;
        LastEntryNo: Integer;
        JobEntryNo: Record "Job Entry No.";
        ProjPersonnel: Record UnknownRecord53946;
        ProjPersonnels: Record UnknownRecord53946;
        ...
        objLabRequest: Record UnknownRecord53910;
        objPImaster: Record UnknownRecord55548;


    procedure AssistEdit(OldJob: Record UnknownRecord53913): Boolean
    begin
        with Job do begin
          Job := Rec;
          JobSetup.Get;
    ...
    var
        PlaningLine: Record UnknownRecord53928;
    begin
    ...
    var
        ...
        JobWIPGLEntry: Record UnknownRecord53930;
    ...
    procedure RecordLinkMove(job: Record UnknownRecord53913;newJob: Record UnknownRecord53913)
    begin
    end;


    procedure CreateDim(mJobs: Record UnknownRecord53913)
    begin
        //Insert grant in Dim No.
        GLSetup.Get;
            with DimVal do begin
