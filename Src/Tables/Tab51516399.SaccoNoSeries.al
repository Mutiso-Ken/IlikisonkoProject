...
Table 51516399 "Sacco No. Series"
{
    ...
    fields
    {
        ...
        field(51516026;"Corporate Account Nos";Code[20])
        {
            TableRelation = "No. Series";
        }
        ...
        field(51516063;"Rental Nos";Code[20])
        {
            DataClassification = ToBeClassified;
            TableRelation = "No. Series";
        }
        field(51516064;"Agency Application Nos.";Code[20])
        {
            DataClassification = ToBeClassified;
            TableRelation = "No. Series";
        }
        field(51516065;"Billing Nos.";Code[20])
        {
            DataClassification = ToBeClassified;
        }
    }
