...
Page 51516662 "Loan Recovery Header22"
{
    PageType = Card;
            ...
            group("Function")
            {
                ...
                action("Post Transaction")
                {
                    ...
                    begin
                        ...
                        if "Recovery Type" = "recovery type"::"Recover From Loanee Deposits" then begin
                            LineNo := 0;
                            FnTransferShareCapitalToDeposits();
                            RunBal := FnRunInterest("Current Shares");
                            FnRunRecoverFromLoaneesDeposits(RunBal);
                        end;


                        if "Recovery Type" = "recovery type"::"4" then begin
                ...
                action("Load Guarantors")
                {
                    ...
                    begin
                        ...
                        if ("Recovery Type" = "recovery type"::"Attach Defaulted Loans to Guarantors") or ("Recovery Type" = "recovery type"::"4") then begin
                            LoanDetails.Reset;
                            ...
                            if LoanGuarantors.FindSet then begin
                                repeat
                                    LoanDetails.Init;
                                    //LoanGuarantors.CALCFIELDS(LoanGuarantors."Deposits variance",LoanGuarantors."Total Committed Shares");
                                    ...
                                    LoanDetails."Guarantors Free Shares" := (LoanGuarantors.Shares - LoanGuarantors."Total Committed Shares");
                                    LoanDetails.Insert;
                        ...
                        if ("Recovery Type" = "recovery type"::"Attach Defaulted Loans to Guarantors") then begin
                            ...
                            if LoanGuarantors.FindSet then begin
                                ...
                                repeat
                                    ...
                                    LoanDetails."Approved Loan Amount" := ROUND(FnGetDefaultorLoanAmount("Loan Distributed to Guarantors", LoanGuarantors."Amont Guaranteed", LoanGuarantors."Total Loans Guaranteed", GCount), 0.05, '>');
                                    ;
                                    LoanDetails."Guarantor Number" := LoanGuarantors."Member No";
                                    LoanDetails."Loan No." := LoanGuarantors."Loan No";
                                    LoanDetails."Amont Guaranteed" := LoanGuarantors."Amont Guaranteed";
                                    ...
                                    IF ObjNoSeries.FINDSET THEN BEGIN
                                      ...
                                      ObjLoansRec.INIT;
                                      ObjLoansRec."Loan  No.":=INCSTR(LastNoUsed);
                                      MESSAGE(FORMAT(ObjLoansRec."Loan  No."));
                                      ObjLoansRec."Application Date":=TODAY;
                                      ObjLoansRec."Client Code":=LoanGuarantors."Member No";
                                      ObjLoansRec."Client Name":=LoanGuarantors.Name;
                                      ObjLoansRec."ID NO":=LoanGuarantors."ID No.";
                                      ...
                                      IF ObjLoanType.GET('DEFAULTER')
                                        ...
                                        ObjNoSeries."Last No. Used":=ObjLoansRec."Loan  No.";
                                        ObjNoSeries.MODIFY;
                                        END;
                                        */
                ...
                action("Apportion Liability")
                {
                    ...
                    begin
                        ...
                        if ObjLoanGuarantors.FindSet then begin
                            repeat
                                VarTotalApprotionGreater := ("Loan Liabilities" - VarTotalApprotionLess) / (VarGuarantorCount - VarTotalApprotionLessCount);
                                if ObjLoanGuarantors."Current Member Deposits" > ObjLoanGuarantors."Equal Liability Amount" then begin
    ...
    begin
        if RunningBalance > 0 then begin
            ...
            if LoanApp.Find('-') then begin
                ...
                GenJournalLine."account type"::Investor, "Member No", "Loan Disbursement Date", VarInterestDeducted, 'BOSA', EXTERNAL_DOC_NO,
    ...
    begin
        loanTypes.Reset;
        loanTypes.SetRange(loanTypes.Code, 'DEFAULTER');
        if loanTypes.Find('-') then begin
            ...
            if LoansRec.Get(LoansRec."Loan  No.") then begin
                ...
                LoansRec."Requested Amount" := ObjLoanDetails."Approved Loan Amount";
    ...
    begin
        if RunningBalance > 0 then begin
            ...
            if LoanApp.Find('-') then begin
                ...
                LineNo := LineNo + 10000;
                SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::"Loan Repayment",
                GenJournalLine."account type"::Investor, LoanApp."Client Code", "Loan Disbursement Date", "Mobile Loan" * -1, 'FOSA', EXTERNAL_DOC_NO,
    ...
    begin
        ...
        if RunningBalance > 0 then begin
            ...
            if LoanApp.Find('-') then begin
                ...
                LineNo := LineNo + 10000;
                SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::"Deposit Contribution",
                GenJournalLine."account type"::Investor, "Member No", "Loan Disbursement Date", VarAmounttoDeduct, 'BOSA', EXTERNAL_DOC_NO,
