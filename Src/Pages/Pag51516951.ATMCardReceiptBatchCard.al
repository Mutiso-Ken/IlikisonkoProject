...
Page 51516951 "ATM Card Receipt Batch Card"
{
            ...
            action(LoadATMApplications)
            {
                ...
                begin
                    ...
                    if ObjCardsApplied.FindSet then begin
                      ...
                      ObjCardsReceipts."ATM Card Account No":=ObjCardsApplied.Name;
                      ObjCardsReceipts."Account Name":=ObjCardsApplied."Date of Birth";
                      ObjCardsReceipts."ATM Card Application Date":=ObjCardsApplied."Maximun Allocation %";
    ...
    var
        ...
        ObjCardsApplied: Record "Members Nominee Temp";
}
