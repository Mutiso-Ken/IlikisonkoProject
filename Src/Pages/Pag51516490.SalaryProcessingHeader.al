                    ...
                    begin
                        ...
                        if salarybuffer.Find('-') then begin
                            repeat
                                ...
                                ObjVendor.SetRange("Vendor Posting Group", 'ORDINARY');
                            ...
                            if RunningBalance > 0 then begin
                                ...
                                if LoanApp."Outstanding Balance" > 0 then begin
                                    ...
                                    if varLRepayment > 0 then begin
                                        ...
                                        LineNo := LineNo + 10000;
                                        SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::"Loan Repayment",
                                        GenJournalLine."account type"::Investor, LoanApp."Client Code", "Posting date", AmountToDeduct * -1, Format(LoanApp.Source), EXTERNAL_DOC_NO,
                                        Format(GenJournalLine."transaction type"::"Loan Repayment"), LoanApp."Loan  No.");
                                        //-------------RECOVER---------------
                                        LineNo := LineNo + 10000;
                                        SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::" ",
                ...
                if enddate >= Today then begin
                    repeat
                        if RunningBalance > 0 then begin
                            ...
                            if ObjStandingOrders."Destination Account Type" <> ObjStandingOrders."destination account type"::Loans then
