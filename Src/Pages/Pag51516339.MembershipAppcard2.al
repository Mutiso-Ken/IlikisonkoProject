...
Page 51516339 "Membership App card 2"
{
    DeleteAllowed = false;
    PageType = Card;
        ...
        area(content)
        {
            group("General Info")
            {
                ...
                field("How Did you know About Us";"How Did you know About Us")
                {
                    ...
                    trigger OnValidate()
                    begin
                        if ("How Did you know About Us"="how did you know about us"::"Another Member") or ("How Did you know About Us"="how did you know about us"::Staff) then
            ...
            group("Function")
            {
                ...
                action("Create Account ")
                {
                    ...
                    begin
                        ...
                        Cust."Personal No":=Saccosetup.BosaNumber;
