...
Page 51516431 "FOSA Account Application Card"
{
    ...
    layout
    {
        ...
        area(factboxes)
        {
            part(Control1000000025; "Mwanangu Birth Cert")
            {
                ApplicationArea = All;
                Caption = 'Picture';
                Editable = MobileNoEditable;
                        ...
                        */
                        ...
                        if AccoutTypes.Get("Account Type") then begin
                            ...
                            if AccoutTypes.Get("Account Type") then
                                if AccoutTypes.Code = '401' then begin
                                    ObjVend.Reset;
                                    ObjVend.SetRange(ObjVend."Account Type", '401');
                                    ObjVend.SetRange(ObjVend."BOSA Account No", "BOSA Account No");
                                    if ObjVend.Find('-') then begin
                                    ...
                                    if "Global Dimension 2 Code" = 'ROMBO' then
                                        branch := '3';
                                    AcctNo := branch + AccoutTypes."Account No Prefix" + "BOSA Account No";
                                end;
