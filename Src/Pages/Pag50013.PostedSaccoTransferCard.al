...
Page 50013 "Posted Sacco Transfer Card"
{
                    ...
                    begin
                        ...
                        if Confirm('Are you sure you want to transfer schedule?', false) = true then begin
                            ...
                            if "Deposit Debit Options" = "deposit debit options"::"Partial Refund" then begin
                                ...
                                GenJournalLine."account type"::Investor, "Source Account", Today, ObjGensetup."Partial Deposit Refund Fee", 'BOSA', '',
                                ...
                                LineNo := LineNo + 10000;
                                SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::"Deposit Contribution",
                                GenJournalLine."account type"::Investor, "Source Account", Today, VarExciseDuty, 'BOSA', '',
                                Remarks + ' ' + "Source Account", '');
    ...
    begin
        ...
        ObjSaccoTransfers.SetRange("Source Account", Rec."Source Account");
