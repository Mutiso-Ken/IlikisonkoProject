...
Page 51516445 "Teller & Treasury Trans Card"
{
    DeleteAllowed = false;
    PageType = Card;
        ...
        area(processing)
        {
            ...
            action("Issue/Return")
            {
                ...
                begin
                    ...
                    ObjCoinage.Reset;
                    ObjCoinage.SetRange(ObjCoinage.No,No);
                    if ObjCoinage.FindSet then begin
                    ObjCoinage.CalcSums(ObjCoinage."Total Amount");
                    CoinageTotal:=ObjCoinage."Total Amount";
                    if CoinageTotal<>Amount then
                    Error('Amount %1 is not equal to Coinage Total =%2',Amount,CoinageTotal);
                    end;
            ...
            action(Receive)
            {
                ...
                begin
                    ...
                    if ("Transaction Type"="transaction type"::"Return To Treasury") or ("Transaction Type"="transaction type"::"Teller to Intra-Day") or
                      ...
                      then
                        begin
                          if ("Custodian 1 Confirm Receipt"<>true) or ("Custodian 2 Confirm Receipt"<>true) then
                            begin
