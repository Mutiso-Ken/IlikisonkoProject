...
Page 51516841 "Change Request Card"
{
    ...
    layout
    {
        area(content)
        {
            ...
            group("Account Info")
            {
                ...
                field("Member Class (New)";"Member Class (New)")
                {
                    ApplicationArea = Basic;
                }
                field(Name;Name)
                ...
                part(Control16;"ChangeReq Picture")
                {
                    ApplicationArea = All;
                ...
                part(Control17;"ChangeReq Signature")
                {
                    ApplicationArea = All;
                ...
                field(Dateofbirthnew;Dateofbirthnew)
                {
                    ApplicationArea = Basic;
                }
                field(Gender;Gender)
        ...
        area(factboxes)
        {
            ...
            part(Control11;"Member Picture-Uploaded")
            {
                Editable = false;
                Enabled = false;
                SubPageLink = "No."=field("Account No");
            }
            part(Control10;"Member Signature-Uploaded")
            {
                Editable = false;
                Enabled = false;
                SubPageLink = "No."=field("Account No");
            }
            part(Control15;"Vendor Picture-Uploaded")
            {
                ApplicationArea = All;
                Caption = '  Fosa picture';
                Editable = true;
                Enabled = true;
                SubPageLink = "BOSA Account No"=field("Account No");
            }
            part(Control14;"Vendor Signature-Uploaded")
            {
                ApplicationArea = All;
                Caption = 'Fosa Signature';
                Editable = false;
                Enabled = false;
                SubPageLink = "BOSA Account No"=field("Account No");
            }
                ...
                begin
                    ...
                    if  ((Type=Type::"Mobile Change") or (Type=Type::"ATM Change") or (Type=Type::"Agile Change")/*OR(Type=Type::"Backoffice Change")*/) then begin
                          ...
                          begin
                            ...
                            // IF "Picture(New Value)"<>'' THEN
                             //  vend.Picture:="Picture(New Value)";
                             ...
                             vend."Phone No.":="Mobile No(New Value)";
                                ...
                                if "Picture(New Value)".Count >0 then
                                  vend.Picture:="Picture(New Value)";
                        ...
                        if Memb.Find('-') then begin
                           if "Name(New Value)"<>'' then
                            ...
                            Memb."Phone No.":="Phone No.(New)";
                             if Dateofbirthnew <> 0D then
                            Memb."Date of Birth":= Dateofbirthnew;
                              if "Gender NEW" <> "gender new"::" " then
                            Memb.Gender:= "Gender NEW";
                            if "ID No(New Value)" <> '' then
                            ...
                            Memb."Member class":="Member Class (New)";
                            if "Marital Status(New Value)" <> "marital status(new value)"::" "  then
                            ...
                            if "Picture(New Value)".Count >0 then
                            Memb.Picture:="Picture(New Value)";
                            if "signinature(New Value)".Count>0 then
    ...
    var
        ...
        MembNxK: Record "Members Nominee";
        cloudRequest: Record "Change Request";
        nxkinvisible: Boolean;
        Kinchangedetails: Record "Members Nominee";
        ...
        MemberNxK: Record "Members Nominee";
