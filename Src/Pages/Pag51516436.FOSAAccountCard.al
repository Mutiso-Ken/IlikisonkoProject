...
Page 51516436 "FOSA Account Card"
{
    ...
    layout
    {
        ...
        area(factboxes)
        {
            ...
            part(Control23;"Vendor Picture-Uploaded")
            {
                Caption = 'picture';
                Editable = true;
                Enabled = true;
            ...
            group(Account)
            {
                ...
                action("BOSA Statement")
                {
                    ...
                    begin
                        ...
                        if Cust.Find('-') then
                        Report.Run(51516354,true,true,Cust);
                    end;
                }
                action("Loan Statement")
                {
                    ...
                    begin
                        ...
                        Cust.SetRange(Cust."No.","BOSA Account No");
                        if Cust.Find('-') then
                        Report.Run(51516531,true,true,Cust);
                    end;
                }
                action("FOSA Loans")
                {
                ...
                action("Close Account")
                {
                    ...
                    begin
                         ...
                         if "Balance (LCY)"-("Uncleared Cheques"+"ATM Transactions"+"EFT Transactions"+GenSetup."Withdrawal Fee"+UnclearedLoan)<0 then
                         Error('This Member does not enough Savings to recover Withdrawal Fee')
                            ...
                            Gnljnline."Bal. Account No.":=GenSetup."Withdrawal Fee Account";
                            Gnljnline.Validate(Gnljnline."Bal. Account No.");
                            Gnljnline."Document No.":='LR-'+"No.";
                            Gnljnline."Posting Date":=Today;
                            Gnljnline.Amount:=-GenSetup."Withdrawal Fee";
                            Gnljnline.Description:='Account Closure Fee';
                            Gnljnline.Validate(Gnljnline.Amount);
                            if Gnljnline.Amount<>0 then
                            Gnljnline.Insert;
                ...
                action("Signatories Details")
                {
                    ...
                    RunPageLink = "BOSA No."=field("BOSA Account No");
                }
            ...
            group(ActionGroup1102755009)
            {
                ...
                action("Charge Fosa Statement")
                {
                    ...
                    begin
                        ...
                        GenJournalLine.Validate(GenJournalLine."Account No.");
                        GenJournalLine."Posting Date":=Today;
                        GenJournalLine.Description:='Statemnt Charge'; //Charges.Description;
                        GenJournalLine.Validate(GenJournalLine."Currency Code");
                        GenJournalLine.Amount:=Charges."Charge Amount";
                        GenJournalLine.Validate(GenJournalLine.Amount);
                        GenJournalLine."Bal. Account Type":=GenJournalLine."bal. account type"::"G/L Account";
                ...
                action("Charge Fosa Card Replacement")
                {
                    ApplicationArea = Basic;
                    Promoted = true;
                    PromotedCategory = Process;
                    ...
                    begin
                        ...
                        if Charges.Find('-') then begin
                          ...
                          GenJournalLine."Journal Template Name":='PURCHASES';
                          GenJournalLine."Journal Batch Name":='FTRANS';
                          GenJournalLine."Document No.":="No."+'CARD';
                          GenJournalLine."Line No.":=LineNo;
                          GenJournalLine."Account Type":=GenJournalLine."account type"::Vendor;
                          GenJournalLine."Account No.":="No.";
                          GenJournalLine.Validate(GenJournalLine."Account No.");
                ...
                action(Attachments)
                {
                    ...
                    var
                        ...
                        RecRef: RecordRef;
                        DocumentAttachmentView: Page UnknownPage1182;
                    begin
                          RecRef.GetTable(Rec);
                          DocumentAttachmentView.OpenForRecRef(RecRef);
                          DocumentAttachmentView.RunModal;
                    end;
                }
            }
        }
