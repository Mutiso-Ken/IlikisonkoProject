...
Page 51516976 "Signatory  Card"
{
    ...
    layout
    {
        area(content)
        {
            ...
            part(Control14;"Signatory Details")
            {
            }
                      ...
                      repeat
                        ...
                        if MembersNomineeTemp."Add New" then begin
                         ...
                         // MemberNominee."Next Of Kin Type":=MembersNomineeTemp."Next Of Kin Type(New)";
                          MemberNominee.Signatory:=MembersNomineeTemp.Signatory;
                          ...
                          //IF MembersNomineeTemp."Next Of Kin Type(New)"<>MembersNomineeTemp."Next Of Kin Type(New)"::" " THEN
                            if MembersNomineeTemp.Signatory<>MembersNomineeTemp.Signatory then
                         // MemberNominee."Next Of Kin Type":=MembersNomineeTemp."Next Of Kin Type(New)";
                            MemberNominee.Signatory:=MembersNomineeTemp.Signatory;
