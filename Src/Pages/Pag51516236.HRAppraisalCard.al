...
Page 51516236 "HR Appraisal Card"
{
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            ...
            part(Control9;"Loans Interest Card")
            {
            ...
            action("Load Sections")
            {
                ...
                begin
                    ...
                    if AppLines.Find('-') then begin
                        if Confirm('Lines exist for this appraisal period do you want to overwrite?',false) = true then
                        begin
