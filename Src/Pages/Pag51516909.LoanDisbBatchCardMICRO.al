...
Page 51516909 "Loan Disb Batch Card(MICRO)"
{
    ...
    begin
        Source:=Source::MICRO;
        "Mode Of Disbursement":="mode of disbursement"::"2";
        UpdateControl();
    end;
    ...
    begin
        ...
        */
        ...
        if "Mode Of Disbursement" = "mode of disbursement"::"4" then begin
          LoanApps.Reset;
          LoanApps.SetRange(LoanApps."Batch No.","Batch No.");
          LoanApps.SetRange(LoanApps."System Created",false);
          if LoanApps.Find('-') then begin
        ...
        repeat
           ...
           if LoanType.Get(LoanApps."Loan Product Type") then begin
            ...
            GenJournalLine.Validate(GenJournalLine.Amount);
            GenJournalLine.Validate(GenJournalLine."Bal. Account No.");
            GenJournalLine."Transaction Type":=GenJournalLine."transaction type"::"Auctioneer Paid";
            GenJournalLine."Loan No":=LoanTopUp."Loan Top Up";
            GenJournalLine."Shortcut Dimension 1 Code":='BOSA';
            GenJournalLine."Shortcut Dimension 2 Code":=LoanApps."Branch Code";
            GenJournalLine.Validate(GenJournalLine."Shortcut Dimension 1 Code");
