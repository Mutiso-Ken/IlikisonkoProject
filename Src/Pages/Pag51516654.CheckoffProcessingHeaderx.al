                ...
                repeat
                    ...
                    if LoanApp."Outstanding Balance" > 0 then begin
                        ...
                        SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::"Loan Repayment",
                                 GenJournalLine."account type"::Investor, LoanApp."Client Code", "Posting date", AmountReceived * -1, 'BOSA', "Document No",
                ...
                if RunBal > 0 then begin
                    ...
                    if LoanApp."Oustanding Interest" > 0 then begin
                        ...
                        SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::"Interest Paid",
                                 GenJournalLine."account type"::Investor, LoanApp."Client Code", "Posting date", InterestToPost * -1, 'BOSA', "Document No",
            ...
            repeat
                if RunBal > 0 then begin
                    ...
                    if (LoanApp."Outstanding Balance" > 0) then begin
                        ...
                        LineNo := LineNo + 10000;
                        SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::"Loan Repayment",
                         GenJournalLine."account type"::Investor, LoanApp."Client Code", "Posting date", PrincipleToPost * -1, 'BOSA', "Document No",
                         Format(GenJournalLine."transaction type"::"Loan Repayment"), LoanApp."Loan  No.");
    ...
    begin
        if AmountReceived > 0 then begin
            ...
            SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::"Deposit Contribution",
             GenJournalLine."account type"::Investor, AccountNo, "Posting date", AmountReceived * -1, 'BOSA', "Document No",
    ...
    begin
        ...
        if RunBal > 0 then begin
            ...
            SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::"Unallocated Funds",
              GenJournalLine."account type"::Investor, AccountNo, "Posting date", RunBal * -1, 'BOSA', "Document No",
