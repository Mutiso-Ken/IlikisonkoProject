...
Page 51516138 "Cashier Transactions Cards"
{
        ...
        area(navigation)
        {
            ...
            action("Suggest Payments")
            {
                ...
                begin
                    ...
                    ReceiptAllocations."Member No":="Member No";
                    ...
                    ReceiptAllocations."Loan No.":='';
                    ReceiptAllocations.Amount:=BosaSetUp."Retained Shares"-Cust."Shares Retained";
                    //ReceiptAllocations."Interest Amount":=Loans."Interest Due";
                    ReceiptAllocations."Total Amount":=ReceiptAllocations.Amount;
                    ReceiptAllocations."Global Dimension 1 Code":='BOSA';
                    ReceiptAllocations."Global Dimension 2 Code":='NAIROBI';
                    ...
                    ReceiptAllocations."Loan No.":=' ';
                    ReceiptAllocations.Amount:=BosaSetUp."Risk Fund Amount";
                    ReceiptAllocations."Total Amount":=ReceiptAllocations.Amount;
                    ReceiptAllocations."Global Dimension 1 Code":='BOSA';
                    ReceiptAllocations."Global Dimension 2 Code":='NAIROBI';
                    ReceiptAllocations.INSERT;*/
    ...
    begin
        ...
        else if ReceiptAllocations."Transaction Type" = ReceiptAllocations."transaction type"::"Loan Form Fee" then
