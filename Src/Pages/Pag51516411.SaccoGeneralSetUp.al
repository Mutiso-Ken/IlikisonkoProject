    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Fosa Interest(%)";"Fosa Interest(%)")
                {
                    ApplicationArea = Basic;
                    Caption = 'Fosa Interest %';
                }
            ...
            group("Fees & Commissions")
            {
                ...
                field("penalty on all arrears";"penalty on all arrears")
                {
                    ApplicationArea = Basic;
                    Caption = 'Penalty on arrears %';
                }
