...
Page 51516830 "Group Application Card"
{
        ...
        area(navigation)
        {
            group("Function")
            {
                ...
                action("Group Members")
                {
                    ...
                    RunPageLink = "Group Code" = field("No.");
                }
                group(Approvals)
                {
                    Caption = '-';
                    ...
                    begin
                        ...
                        if "ID No." <> '' then begin
                            ...
                            if Cust.Find('-') then begin
                                if (Cust."No." <> "No.") and ("Account Category" = "account category"::Group) and (Cust.Status = Cust.Status::Active) then
                    ...
                    begin
                        ...
                        if Confirm('Are you sure you want to Create Account Application?', false) = true then begin
                            ...
                            if "ID No." <> '' then begin
                                Cust.Reset;
                                Cust.SetRange(Cust."ID No.", "ID No.");
                                Cust.SetRange(Cust.Name, UpperCase(Name));
                                Cust.SetRange(Cust."Customer Type", Cust."customer type"::MicroFinance);
                                if Cust.Find('-') then begin
                                    if Cust."No." <> "No." then
                            ...
                            BOSAACC := AcctNo;
                            Message('Corporate Account No. is  %1', BOSAACC);
                            Cust.Reset;
                            ...
                            if AccountSignatoriesApp.Find('-') then begin
                                ...
                                if AccountSignatoriesApp.Find('-') then begin
                                    repeat
                                        ...
                                        SMSMessage."SMS Message" := Name + ' has been succesfully created.ILKISONJKO SACCO';
                            ...
                            Accounts."BOSA Account No" := AcctNo;
                            ...
                            Accounts."Vendor Posting Group" := 'GROUP';
                            ...
                            AccoutTypes.Reset;
                            AccoutTypes.SetRange(AccoutTypes.Code, 'GROUP');
                            if AccoutTypes.Find('-') then begin
                       ...
                       Notification.Send;
                        ...
                        if GenSetUp."Send Membership Reg SMS" = true then
                            SURESTEPFactory.FnSendSMS('MCMEMBERAPP', 'Your Microfinance account has been successfully created ', Cust."No.", "Contact Person");
                        Message('Account created successfully.');
                        Message('The Group Account no is %1', Cust."No.");
                        CurrPage.Close;
    ...
    begin
        if (Rec.Status = Status::Approved) and ("Assigned No." <> '') then
    ...
    begin
        ...
        if GenSetUp."Auto Open FOSA Savings Acc." = true then begin
            ...
            notifymail.CreateMessage(' Nafaka sacco Ltd Membership', GenSetUp."Sender Address", "E-Mail (Personal)", 'You membership application was received',
