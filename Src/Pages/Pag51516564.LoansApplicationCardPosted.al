...
Page 51516564 "Loans Application Card(Posted)"
{
    DelayedInsert = false;
    DeleteAllowed = false;
    Editable = true;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Stop Interest Accrual"; "Stop Interest Accrual")
                {
                    ApplicationArea = Basic;
                    Editable = StopIntEditable;

                    trigger OnValidate()
                    begin
                        StopIntEditable := true;
                    end;
                }
                ...
                field("Exempt interest"; "Exempt interest")
                {
                    ApplicationArea = Basic;
                }
            ...
            group(Loan)
            {
                ...
                action("Cancel Loan And Fine")
                {
                    ...
                    begin
                        ...
                        GenJournalLine.SetRange("Journal Batch Name", 'FINE');
                        ...
                        if Memb.Find('-') then begin
                            FineAmount := 0;
                            FineAmount := "Approved Amount" * 0.1;
                            LineNo := LineNo + 10000;

                            GenJournalLine.Init;
                            GenJournalLine."Journal Template Name" := 'PURCHASES';
                            GenJournalLine."Journal Batch Name" := 'FINE';
                            GenJournalLine."Document No." := Format('FINE' + "Loan  No.");
                            GenJournalLine."External Document No." := "Loan  No.";
                            GenJournalLine."Line No." := LineNo;
                            GenJournalLine."Account Type" := GenJournalLine."account type"::"G/L Account";
                            GenJournalLine."Account No." := Memb."FOSA Account No.";
                            GenJournalLine.Validate(GenJournalLine."Account No.");
                            GenJournalLine."Posting Date" := Today;
                            GenJournalLine.Validate(GenJournalLine."Currency Code");
                            GenJournalLine.Amount := -FineAmount;
    ...
    var
        ...
        DisbursedAmountEditable: Boolean;
