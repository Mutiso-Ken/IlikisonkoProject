...
Page 51516007 "Cash Payment Header"
{
        ...
        area(processing)
        {
            group("&Functions")
            {
                    ...
                    begin
                        if Usersetup.Get(UserId) then begin
                            if Usersetup."Post Staff Grants" = false then
                                Error('You dont have permissions to Post Cash Payment! ')
                        end;
                        "Posting Date" := Date;
                        if Status = Status::Posted then
                            Error('This Payment has already been posted');
                ...
                action("Send A&pproval Request")
                {
                    ...
                    begin
                        ...
                        if ApprovalsMgmt.CheckPettyCashApprovalsWorkflowEnabled(Rec) then
                            ApprovalsMgmt.OnSendPettyCashForApproval(Rec);
                    end;
                }
                ...
                action("Check Budgetary Availability")
                {
                    ...
                    begin
                        if not (Status = Status::New) then begin
                        ...
                        CheckBudgetAvail.CheckPaymentsPettyCash(Rec);
                    end;
                }
    ...
    begin
        ...
        "Global Dimension 2 Code" := SureFactory.FnGetUserBranch();
        //VALIDATE("Global Dimension 2 Code");
    ...
    begin
        ...
        if Payments.Find('-') then begin
            ...
            if PayLine.Find('-') then begin
                PayLine.Posted := true;
                PayLine."Posting Date" := "Posting Date";
