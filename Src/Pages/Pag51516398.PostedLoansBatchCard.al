        ...
        area(navigation)
        {
            group(LoansB)
            {
                ...
                action("Post ")
                {
                    ...
                    begin
                        ...
                        if ("Mode Of Disbursement" = "mode of disbursement"::Cheque) or
                           ("Mode Of Disbursement" = "mode of disbursement"::"Transfer to FOSA") then
                        ...
                        if (LoanApps.Source = LoanApps.Source::BOSA) and
                           ("Mode Of Disbursement" <> "mode of disbursement"::"3") then
                        ...
                        if "Mode Of Disbursement" = "mode of disbursement"::"3" then begin
                        DActivity:='';
                        DBranch:='';
                        ...
                        repeat
                            ...
                            if ("Mode Of Disbursement" = "mode of disbursement"::"3") or
                               ("Mode Of Disbursement" = "mode of disbursement"::"2") then begin
                        ...
                        //Transfer to FOSA
                        if ("Mode Of Disbursement"="mode of disbursement"::"2") or
                           ("Mode Of Disbursement"="mode of disbursement"::"3") then begin
                        DActivity:='FOSA';
                        DBranch:='NAIROBI';
                ...
                action("Print Cheque")
                {
                    ...
                    trigger OnAction()
                    begin
                            if ( "Mode Of Disbursement"="mode of disbursement"::"4" ) or ( "Mode Of Disbursement"="mode of disbursement"::"5" ) then
