            ...
            group(Suggest)
            {
                ...
                action("Suggest Payments")
                {
                    ...
                    begin
                        ...
                        if Cust."Registration Date" >20140301D then begin
                        ...
                        ReceiptAllocations."Document No":="Transaction No.";
                        ReceiptAllocations."Member No":="Account No.";
                        ReceiptAllocations."Transaction Type":=ReceiptAllocations."transaction type"::"FOSA Shares";
                        ReceiptAllocations."Loan No.":='';
        ...
        area(processing)
        {
            action(Post)
            {
                ...
                begin
                    ...
                    else if ReceiptAllocations."Transaction Type" = ReceiptAllocations."transaction type"::"Loan Insurance Charged" then
                    ...
                    else GenJournalLine.Description:='BT'+'-'+Remarks+'-'+Format("Receipt Mode")+'-'+"Cheque No.";
