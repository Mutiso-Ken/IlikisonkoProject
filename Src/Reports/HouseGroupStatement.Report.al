...
Report 51516920 "House Group Statement"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/House Group Statement.rdlc';
    ...
    dataset
    {
        dataitem("Member House Groups"; "Member House Groups")
        {
            ...
            dataitem("Member Register"; "Member Register")
            {
                ...
                column(TotalLoansOutstanding_MembersRegister; "Member Register"."Total Loans Outstanding")
                {
                }
                ...
                column(HouseGroupStatus_MembersRegister; "Member Register"."House Group Status")
                {
                }
                ...
                begin
                    ...
                    ObjLoanCollateral.SetRange(ObjLoanCollateral."Member No", "Member Register"."No.");
                        ...
                        repeat
                            ...
                            if ObjLoans."Outstanding Balance" > 0 then begin
                                if ObjLoans."Repayment Frequency" = ObjLoans."repayment frequency"::Monthly then begin
                                    ...
                                    VarRepayDate := Date2dmy(ObjLoans."Repayment Start Date", 1);
                    ...
                    VarMemberGuarantorshipLiability := Sfactory.FnGetMemberLiability("Member Register"."No.");
                end;
            }
