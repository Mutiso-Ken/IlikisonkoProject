...
Report 51516911 "FOSA Account Balances"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/FOSA Account Balances.rdlc';
    ...
    dataset
    {
        dataitem(Vendor;Vendor)
        {
            ...
            RequestFilterFields = "No.","Account Type","Employer Code","Vendor Posting Group",Balance;
