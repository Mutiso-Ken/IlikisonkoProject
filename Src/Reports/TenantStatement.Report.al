...
Report 51516977 "Tenant Statement"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Tenant Statement.rdlc';
    ...
    dataset
    {
        dataitem(Vendor;Vendor)
        {
            ...
            {
                DataItemLink = DocNo=field("No."),"Posting Date"=field("Date Filter"),"Global Dimension 1 Code"=field("Global Dimension 1 Filter"),"Global Dimension 2 Code"=field("Global Dimension 2 Filter");
                ...
                column(VendorBalanceLCY;VendorBalanceLCY)
                {
                }
                ...
                begin
                    ...
                    if VendorLedgerEntry.Find('-') then begin
                      ...
                      VendorBalanceLCY:=Vendor."Balance (LCY)";
                    end;
