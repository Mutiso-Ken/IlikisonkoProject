...
Report 51516494 "Loan Appraisal-FOSA"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Loans Register"; "Loans Register")
        {
            ...
            column(LoanInterestDue; LoanInterestDue)
            {
            }
            ...
            begin
                ...
                if ("Loans Register".Posted = false) then begin
                    if "Loans Register"."Repayment Method" = "Loans Register"."repayment method"::Constants then
                        "Loans Register"."Interest Upfront Amount" := "Recommended Amount" * "Loans Register".Interest / 100;
    ...
    begin
        if LoanType.Get("Loans Register"."Loan Product Type") then begin
            //*********1st time loanee
            if "Loans Register"."1st Time Loanee" = true then
                DEpMultiplier := LoanType."Deposit Multiplier 1st Loan" * ("Loans Register"."Boosted Amount" + Cshares)
            else
                DEpMultiplier := LoanType."Deposits Multiplier" * ("Loans Register"."Boosted Amount" + Cshares);
            //*********1st time loanee
        ...
        DepX := DEpMultiplier - TotalLoanBal;
    end;
    ...
    begin
        ...
        if "Loans Register"."Loan Product Type" <> 'FOSALOAN' then
            Psalary := "Loans Register"."Net Utilizable Amount";
    end;
    ...
    begin
        ...
        if LoanType.Get("Loans Register"."Loan Product Type") then begin
            ...
            LoanInsurance := 0;
            LoanInsurance := SFactory.FnGetChargeFee("Loans Register"."Loan Product Type", "Loans Register"."Approved Amount", 'LINS');
            ProcessingFee := SFactory.FnGetChargeFee("Loans Register"."Loan Product Type", "Loans Register"."Approved Amount", 'LPF');
            LoanFormFee := SFactory.FnGetChargeFee("Loans Register"."Loan Product Type", "Loans Register"."Approved Amount", 'LFMF');
            LAppraisalFee := SFactory.FnGetChargeFee("Loans Register"."Loan Product Type", "Loans Register"."Approved Amount", 'LAP');
            LoanTransferFee := SFactory.FnGetTransferFee("Loans Register"."Mode of Disbursement");
            LoanInterestDue := "Loans Register"."Approved Amount" * "Loans Register".Interest / 1200;
            BridgeLevy := ROUND("Loans Register"."Topup Commission", 1, '>');
            ...
            "Loans Register"."Boosted Amount Interest" + "Loans Register"."Boosting Commision" + TotalBridgeAmount + LoanInterestDue;
    ...
    begin
        ...
        if "Loans Register"."Repayment Method" = "Loans Register"."repayment method"::Constants then begin
            if LoanType.Get("Loans Register"."Loan Product Type") then begin
                "Loans Register".TestField(Installments);
                LPrincipal := ROUND(LoanAmount / RepayPeriod, 1, '>');
                if LoanType.Code = 'ADVANCE1B' then
