...
Report 51516531 "Loan Statement"
{
    DefaultLayout = RDLC;
        ...
        dataitem("Member Register";"Member Register")
        {
            ...
            dataitem(Loans;"Loans Register")
            {
                ...
                dataitem(loan;"Member Ledger Entry")
                {
                    ...
                    DataItemTableView = sorting("Posting Date") where("Transaction Type"=filter(Loan|"Loan Repayment"|"Interest Paid"|"CRB Fees"|"Loan Insurance Paid"|"Recovery Account"|"Penalty Charged"|"Penalty Paid"|"FOSA Account"),Reversed=const(false));
