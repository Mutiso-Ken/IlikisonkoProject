...
Report 51516461 "Process Standing Orders"
{
    ...
    dataset
    {
        ...
        {
            DataItemTableView = where("Creditor Type" = const("Savings Account"), Status = const(Active), Blocked = filter(<> All));
            ...
            dataitem("Standing Orders"; "Standing Orders")
            {
                ...
                DataItemTableView = sorting("No.") where(Status = const(Approved), Effected = filter(false));
                ...
                begin
                    ...
                    if ("Standing Orders"."Next Run Date" = Today) then
                    //IF ("Standing Orders"."Next Run Date"=CALCDATE('200221D')) THEN
                      begin
                        ...
                        if AvailableBal >= "Standing Orders".Amount then begin
                            ...
                            if "Standing Orders"."Destination Account Type" = "Standing Orders"."destination account type"::Loans then begin
    ...
    begin
        ...
        ObjStoRegister."Amount Deducted" := "Standing Orders"."Allocated Amount";
