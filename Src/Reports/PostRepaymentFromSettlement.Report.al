                ...
                if ObjRepamentSchedule.FindSet then begin
                    ...
                    if ObjAccounts.FindSet then begin
                        ...
                        if AvailableBal >= VarTotalRepaymentDue then begin
                            ...
                            GenJournalLine."account type"::Investor, "Client Code", Today, 'Insurance Paid from Settlement', GenJournalLine."bal. account type"::Vendor, ObjAccounts."No.",
                            ...
                            GenJournalLine."account type"::Investor, "Client Code", Today, 'Interest Paid from Settlement', GenJournalLine."bal. account type"::Vendor, ObjAccounts."No.",
                            ...
                            LineNo := LineNo + 10000;
                            SFactory.FnCreateGnlJournalLineBalanced(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::"Interest Paid",
                            GenJournalLine."account type"::Investor, "Client Code", Today, 'Principle Repayment from Settlement', GenJournalLine."bal. account type"::Vendor, ObjAccounts."No.",
