...
Report 51516890 "FOSA Account Statement Ver.1.0"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(Vendor;Vendor)
        {
            ...
            dataitem("Vendor Ledger Entry";"Vendor Ledger Entry")
            {
                ...
                DataItemTableView = sorting("Vendor No.","Posting Date") where(Reversed=const(false),"Document No."=filter(<>'QCC7JR3UKD'));
                ...
                begin
                    ...
                    VendorLedgerEntry.SetRange(VendorLedgerEntry."Date Filter","Vendor Ledger Entry"."Date Filter");
