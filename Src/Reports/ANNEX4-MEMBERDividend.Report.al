...
Report 51516892 "ANNEX 4 - MEMBER Dividend"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/ANNEX 4 - MEMBER Dividend.rdlc';
    ...
    dataset
    {
        dataitem("Member Register";"Member Register")
        {
            ...
            column(MemberShareClass_MembersRegister;"Member Register"."Member Share Class")
            {
            }
