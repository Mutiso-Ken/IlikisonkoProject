...
Report 51516973 "Loan Statement GROUP"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Loan Statement GROUP.rdlc';
        ...
        dataitem("Member Register";"Member Register")
        {
            ...
            dataitem(Loans;"Loans Register")
            {
                ...
                dataitem(loan;"Member Ledger Entry")
                {
                    ...
                    DataItemTableView = sorting("Posting Date") where("Transaction Type"=filter(Loan|"Loan Repayment"|"Interest Paid"|"CRB Fees"|"Loan Insurance Paid"|"Recovery Account"),Reversed=const(false));
                    ...
                    begin
                        ...
                        if ((loan."Transaction Type"=loan."transaction type"::"CRB Fees") or (loan."Transaction Type"=loan."transaction type"::"Interest Paid")) then
