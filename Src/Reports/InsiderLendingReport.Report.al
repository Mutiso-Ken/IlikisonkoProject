...
Report 51516875 "Insider Lending Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Insider Lending Report.rdlc';
    ...
    dataset
    {
        dataitem("Loans Register"; "Loans Register")
        {
            ...
            DataItemTableView = sorting("Loan  No.") order(ascending) where("Insider Board" = filter(true), "Outstanding Loan" = filter(> 0));
