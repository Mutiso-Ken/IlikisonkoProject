...
Report 51516500 "Transaction Slip - ChDepositX"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Transaction Slip - ChDepositX.rdlc';
    ...
    dataset
    {
        dataitem(Transactions;Transactions)
        {
            ...
            column(Transactions__Staff_Payroll_No_;"Staff/Payroll No")
            {
            }
            ...
            dataitem("Receipt Allocation";"Receipt Allocation")
            {
                ...
                column(ReportForNavId_5909; 5909)
                {
                }
            }
