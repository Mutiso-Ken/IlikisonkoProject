...
Report 51516887 "Member List Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Member List Report.rdlc';
    ...
    dataset
    {
        dataitem("Member Register";"Member Register")
        {
            ...
            RequestFilterFields = "No.",Status,"Employer Code","Personal No","Current Shares","Registration Date",colleges,"Retirement Date","Member class";
            ...
            column(RetirementDate;"Member Register"."Retirement Date")
            {
            }
            column(TotalLoansOutstanding_MemberRegister;"Member Register"."Total Loans Outstanding")
            {
            }
