...
Report 51516522 "Loans Risk Classifications"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Loans Risk Classifications.rdlc';
    ...
    dataset
    {
        dataitem(Loans;"Loans Register")
        {
            ...
            RequestFilterFields = "Loan Product Type","Issued Date","Last Advice Date","Advice Type","Loan Status","Outstanding Balance";
            ...
            begin
                ...
                until LoansT.Next=0;
                 ...
                 LoansT.Reset;
                 LoansT.SetRange(LoansT."Loan  No.",Loans."Loan  No.");
                 //LoansT.SETRANGE(LoansT."Loans Category",LoansT."Loans Category"::Loss);
                 ...
                 repeat
                 if LoansT."Outstanding Balance">0 then begin
                  LOSSBAL:=LOSSBAL+LoansT."Outstanding Balance";//`LoansT."Static Balance";//LoansT."Outstanding Balance";"Loans Category-SASRA"
            ...
            begin
                DFilter:=Loans.GetFilter(Loans."Date filter");
            end;
        }
    }
