...
Report 51516876 "Insider Lending Report Staff"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Insider Lending Report Staff.rdlc';
    ...
    dataset
    {
        dataitem("Loans Register"; "Loans Register")
        {
            ...
            DataItemTableView = sorting("Loan  No.") order(ascending) where("Insider Lending" = filter(true), "Outstanding Loan" = filter(> 0));
            ...
            {
                DataItemLink = "Bosa Member account" = field("Client Code");
