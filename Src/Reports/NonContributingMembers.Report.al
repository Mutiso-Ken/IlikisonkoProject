...
Report 51516880 "Non Contributing Members"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Non Contributing Members.rdlc';
    ...
    var
        ...
        Name: Text;
        PICTURE: Text;
        AllowableLastTransDate: Date;
        DaysInArrears: Integer;

    local procedure FnGetMinTransDate()
    begin
        GenSetUp.Get();
        AllowableLastTransDate:=CalcDate(GenSetUp."Last Transaction Duration",WorkDate);
    end;
}
