...
Report 51516918 "Benevolent Fund Report."
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        ...
        {
            DataItemTableView = where("Benevolent Fund No"=filter(<>''));
            ...
            column(BenevolentFundNo_MembersRegister;"Member Register"."Benevolent Fund No")
            {
            }
