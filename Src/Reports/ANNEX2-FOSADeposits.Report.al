...
Report 51516877 "ANNEX 2 - FOSA Deposits"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/ANNEX 2 - FOSA Deposits.rdlc';
    ...
    dataset
    {
        ...
        {
            CalcFields = Balance;
            DataItemTableView = where(Balance=filter(<>0),"Vendor Posting Group"=filter(<>'TCREDITORS'));
            PrintOnlyIfDetail = false;
            RequestFilterFields = "No.",Status,"Employer Code","Personal No.","Current Shares","Date Filter";
            ...
            column(Interestrate_Vendor;Vendor."Interest rate")
            {
            }
