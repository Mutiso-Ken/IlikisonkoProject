...
Report 51516491 "Process Salaries BatchX"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Process Salaries BatchX.rdlc';
    ...
    dataset
    {
        dataitem("Salary Processing Lines";"Salary Processing Lines")
        {
            ...
            column(ReportForNavId_7751; 7751)
            {
            }
            ...
            column(Salary_Processing_Buffer__No__;"No.")
            {
            }
            column(Salary_Processing_Buffer__Account_No__;"Account No.")
            {
            }
            column(Salary_Processing_Buffer__Staff_No__;"Staff No.")
            {
            }
            column(Salary_Processing_Buffer_Name;Name)
            {
            }
            column(Salary_Processing_Buffer_Amount;Amount)
            {
            }
            column(Salary_Processing_Buffer__Account_Not_Found_;"Account Not Found")
            {
            }
            ...
            dataitem("Standing Orders";"Standing Orders")
            {
                ...
                begin
                    ...
                    if AmountDed > 0 then begin
                    ActualSTO:=0;
                    if ("Standing Orders"."Destination Account Type" = "Standing Orders"."destination account type"::Loans) and ("Standing Orders".Status="Standing Orders".Status::Approved) then begin
                    //PostBOSAEntries();
                    //AmountDed:=ActualSTO;
                    AmountDed:=Amount;
                    //***********************BOSA  Entries
                    ...
                    if ReceiptAllocations."Transaction Type" = ReceiptAllocations."transaction type"::"Ordinary Savings" then begin
                    ...
                    else if ReceiptAllocations."Transaction Type" = ReceiptAllocations."transaction type"::"45" then
                    ...
                    if (ReceiptAllocations."Transaction Type" = ReceiptAllocations."transaction type"::"Ordinary Savings")
                    ...
                    GenJournalLine."Journal Batch Name":='SALARIES';
                    GenJournalLine."Document No.":=SalaryHeader."Document No";
                    if "Standing Orders"."Destination Account Type" = "Standing Orders"."destination account type"::BOSA then
                  ...
                  if RunBal > 0 then begin
                    ...
                    if Loans."Oustanding Interest" > 0 then begin
                      ...
                      if Interest > 0 then begin
                        ...
                        //GenJournalLine.VALIDATE(GenJournalLine."Account No.","Salary Processing Lines"."Account No.");
                        if Loans."Issued Date"<20161105D then begin
