...
Report 51516896 "Loan Application Form"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Loan Application Form.rdlc';
    ...
    dataset
    {
        dataitem("Loans Register";"Loans Register")
        {
            ...
            begin
                ...
                Cust.CalcFields(Cust."Current Shares",Cust."Shares Retained",Cust."Khoja Shares");
                Cshares:=Cust."Current Shares";
                ShareCap:=Cust."Shares Retained";
                PlazaShares:=Cust."Khoja Shares";
                MemberID:=Cust."ID No.";
