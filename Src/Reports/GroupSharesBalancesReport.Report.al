...
Report 51516906 "Group Shares Balances Report."
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Group Shares Balances Report..rdlc';
    ...
    dataset
    {
        dataitem("Member Register";"Member Register")
        {
            ...
            column(GroupShares_MembersRegister;"Member Register"."Group Shares")
            {
            }
            column(GroupAccountNo_MembersRegister;"Member Register"."Group Account No")
            {
            }
