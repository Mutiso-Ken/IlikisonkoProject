...
Report 51516454 "Dormant account report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Dormant account report.rdlc';

    dataset
    {
        dataitem(Customer;"Member Register")
        {
            DataItemTableView = sorting("No.") where("Customer Type"=const(Member),Status=filter(Dormant));
