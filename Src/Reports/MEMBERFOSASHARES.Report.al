...
Report 51516878 "MEMBER FOSA SHARES"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/MEMBER FOSA SHARES.rdlc';
    ...
    dataset
    {
        dataitem("Member Register";"Member Register")
        {
            ...
            RequestFilterFields = "No.",Status,"Employer Code","Personal No","FOSA Shares","Date Filter";
            ...
            column(FOSAShares_MemberRegister;"Member Register"."FOSA Shares")
            {
            }
