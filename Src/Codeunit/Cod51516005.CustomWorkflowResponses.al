...
Codeunit 51516005 "Custom Workflow Responses"
{
    ...
    procedure ReleaseATMCard(var ATMCard: Record "Members Nominee Temp")
    var
        ATM: Record "Members Nominee Temp";
    begin
          ATMCard.Reset;
    ...
    procedure ReOpenATMCard(var ATMCard: Record "Members Nominee Temp")
    var
        ATM: Record "Members Nominee Temp";
    begin
          ATMCard.Reset;
    ...
    procedure ReleaseMemberAgentNOKChange(var MemberAgentNOKChange: Record "Next Of Kin Change")
    var
        MAgentNOKChange: Record "Next Of Kin Change";
    begin
    ...
    procedure ReOpenMemberAgentNOKChange(var MemberAgentNOKChange: Record "Next Of Kin Change")
    var
        MAgentNOKChange: Record "Next Of Kin Change";
    begin
          MemberAgentNOKChange.Reset;
