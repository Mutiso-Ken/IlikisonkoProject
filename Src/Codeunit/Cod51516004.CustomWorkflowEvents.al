...
Codeunit 51516004 "Custom Workflow Events"
{
    ...
    procedure RunWorkflowOnSendATMCardForApproval(var ATMCard: Record "Members Nominee Temp")
    begin
    ...
    procedure RunWorkflowOnCancelATMCardApprovalRequest(var ATMCard: Record "Members Nominee Temp")
    begin
    ...
    procedure RunWorkflowOnSendMemberAgentNOKChangeForApproval(var MemberAgentNOKChange: Record "Next Of Kin Change")
    begin
    ...
    procedure RunWorkflowOnCancelMemberAgentNOKChangeApprovalRequest(var MemberAgentNOKChange: Record "Next Of Kin Change")
    begin
