...
Codeunit 51516019 "Bank Acc. Set Recon.-No. H"
{
    ...
    procedure ApplyEntries2(var BankAccReconLine: Record "Bank Acc. Reconciliation Line";var BankAccLedgEntry: Record "Bank Account Ledger Entry";Relation: Option "One-to-One","One-to-Many";BankAccStatementLine: Record UnknownRecord51516012): Boolean
    begin
        BankAccLedgEntry.LockTable;
        CheckLedgEntry.LockTable;
        BankAccReconLine.LockTable;
